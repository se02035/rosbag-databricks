...
variable_array_type
    : dtype (OPEN_BRACKET | STRING_OPEN_BRACKET) (CLOSE_BRACKET | STRING_CLOSE_BRACKET)
    ;

fixed_array_type
    : dtype OPEN_BRACKET INTEGER_LITERAL CLOSE_BRACKET
    | dtype STRING_OPEN_BRACKET STRING_INTEGER_LITERAL STRING_CLOSE_BRACKET
    ;
